	  	...
	  	<div class="container">
			<div class="row" style="margin: 0px auto">
				...
				<table class="table">
					...
					<tr>
						<td class="text-right">
							<button class="btn-xs btn-primary">예약</button>
						...
						<td>
							<table class="table" v-for="rvo in store.reply">
								<tr>
									...
									<td class="text-right">
										<a href="#" class="btn btn-xs btn-success" v-if="store.sessionId===rvo.id">수정</a>
				...
				<table class="table">
					<tr>
						<td class="text-center">
							<textarea rows="2" cols="60" style="float: left" ref="msgRef" v-model="store.msg"></textarea>
							<button class="btn-success" style="width:80px;height: 54px;float: left" @click="store.foodReplyInsert(fno,msgRef)">댓글쓰기</button>
						</td> 
					</tr>
				</table>
			  </c:if>
		...
		const app=createApp({
			setup(){
	    		...
	    		const addScript=()=>{
	    			...
	    			script.src='http://dapi.kakao.com/v2/maps/sdk.js?autoload=false&appkey=7d1d66f384fdb4c354c90e65a97ae96e&libraries=services'
