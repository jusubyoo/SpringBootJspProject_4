            	...
            	<table class="table">
            		<tbody>
            			<tr>
            				...
            				<th width="30%" class="text-center">{{store.vo.no}}</th>
            				<th width="20%" class="text-center success">작성일</th>
            				<th width="30%" class="text-center">{{store.vo.dbday}}</th>
            			</tr>
            			<tr>
            				<th width="20%" class="text-center success">이름</th>
            				<th width="30%" class="text-center">{{store.vo.name}}</th>
            				<th width="20%" class="text-center success">조회수</th>
            				<th width="30%" class="text-center">{{store.vo.hit}}</th>	
            			</tr>
            			<tr>
            			...
            			<tr>
            				<td colspan="4" class="text-right">
            					<a :href="'/board/update?no='+store.vo.no" class="btn btn-xs btn-primary">수정</a>
            					<a :href="'/board/delete?no='+store.vo.no" class="btn btn-xs btn-primary">삭제</a>
            					<a href="/board/list" class="btn btn-xs btn-primary">목록</a>
            				</td>
            			</tr>
            		</tbody>
            	</table>
